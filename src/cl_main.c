...
#define KTX 	"bf,changing,cmd ack,cmd new,cmd pext,cmd prespawn,cmd spawn,color,infoset,sinfoset," \
		"ktx_infoset,ktx_sinfoset,fullserverinfo,on_enter,on_enter_ctf,on_enter_ffa,"         \
		"on_spec_enter,on_spec_enter_ctf,on_spec_enter_ffa,packet,play,reconnect,skin,skins," \
		"team"

static void KTX_Init(void);
...
static void KTX_Init(void)
{
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias 10on10 cmd 10on10 %0\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias bloodfest cmd bloodfest\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias botcmd cmd botcmd %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias break cmd break\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias callalias cmd callalias %0\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias cmdslist_dl cmd cmdslist_dl %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias coach cmd coach\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias colorforce cmd colorforce\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias info cmd info %0\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias kick cmd kick %0\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias mapslist_dl cmd mapslist_dl %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias mctf cmd mctf\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias messages cmd messages\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias n cmd n\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias pitchsl cmd pitchsl\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias pos_velocity cmd pos_velocity %0\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-l cmd s-l %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-m cmd s-m %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-p cmd s-p %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-r cmd s-r %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-t cmd s-t %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias scores cmd scores\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias skinforce cmd skinforce\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias uinfo cmd uinfo %0\n");
	...
	Cbuf_AddTextEx(&cbuf_main, "tempalias y cmd y\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias yawnmode cmd yawnmode\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias yawsl cmd yawsl\n");
